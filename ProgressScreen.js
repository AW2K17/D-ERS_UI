...
export const ProgressScreen = () => {
    ...
    const endTime = async () => {
        ...
        console.log(data);
        setVisible(true);
        // axios.post('http://192.168.1.101:3023/api-gateway/current-user/exercise-track/addRunning', data, { withCredentials: true })
        //     .then(res => {
        //         console.log(res);
        //     })
        //     .catch(error => {
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <Modal
                    ...
                    <Card disabled={true}>
                        ...
                        <Button onPress={() => setVisible(false)} style={{ width: 127, backgroundColor: 'red', marginLeft: 100, marginTop: 10, borderRadius: 20 }}>
                            OK
                        </Button>
                    </Card>
                </Modal>
